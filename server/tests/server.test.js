    ...
    it('should create a user', (done) => {
        ...
        .expect((res) => {
            ...
            User.findOne({email}).then((user) => {
                ...
                //catch provides clear error message
                //rather than having test never passing
                //previous assertions and calling done()
                //and only giveing a vague err on timeout
            }).catch((e) => done(e));
        });
    });
